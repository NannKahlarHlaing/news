            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <iframe width="100%" height="500px" src="https://www.youtube.com/embed/2WFBq-EaI9Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
