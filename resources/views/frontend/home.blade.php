               ...
               <div class="row d-flex align-items-center">
                ...
                <div class="col-md-9">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control bg-transparent rounded" placeholder="Enter your name" aria-label="Enter your name" aria-describedby="button-addon2">
                        <button class="btn btn-danger" type="button" id="addon2">Sign Up</button>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="" id="" type="checkbox" value="checkedValue" aria-label="Text for screen reader" checked><span> Subscribe me to the daily newsletter.</span>
                    </div>
                </div>
           </div>
            </div>
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-2 text-end">
                                <div class=" btn-circle mb-3 border border-danger">
                                    <i class="fa-brands fa-facebook-f text-danger"></i>
                                </div>
                            </div>
                            <div class="col-10">
...
<section class=" mb-4">
 ...
 <!-- Bootstrap Carousel Modal -->
  <div id="carouselModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="carouselModalLabel"
       aria-hidden="true">
