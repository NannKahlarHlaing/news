                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('cartoonist_en') is-invalid @enderror" id="cartoonist_en" name="cartoonist_en" value="{{ old('cartoonist_en') }}">
                                @error('cartoonist_en')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('cartoonist_mm') is-invalid @enderror" id="cartoonist_mm" name="cartoonist_mm" value="{{ old('cartoonist_mm') }}">
                                @error('cartoonist_mm')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                        ...
                        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('cartoonist_ch') is-invalid @enderror" id="cartoonist_ch" name="cartoonist_ch" value="{{ old('cartoonist_ch') }}">
                                @error('cartoonist_ch')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
